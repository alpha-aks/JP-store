...
function SearchBar() {
    ...
    return (
        <div className="w-full min-w-0 lg:min-w-[500px] rounded-lg border border-neutral-200 overflow-hidden flex items-center h-11 sm:h-12 lg:h-full bg-slate-50 shadow-xs">
            <div>
                {
