                                ...
                                >
                                    {images.map((image, index) => (
                                        <img
                                            ...
                                            src={image}
                                            alt="Thumbnail"
                                            className={`w-20 h-20 object-cover rounded-lg cursor-pointer snap-center transition-transform hover:scale-110 border-2 ${selectedImage === image ? "border-green-500" : "border-transparent"
                                                }`}
                ...
                <div className="flex flex-col w-full h-full bg-white pb-10">
                    <div className="sticky top-24 pt-10 pb-15 bg-white px-10 ">
                        ...
                        <div className="my-5">
                            ...
                            <div className="mt-5">
                                <h3 className="font-bold">Why shop from Jp Store?</h3>
